...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Modbustcp_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 40, 5)
    ...
    "Modbustcp\0sigMessageToUpperLayer\0\0"
    "level\0error\0"
};
...
void Modbustcp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Modbustcp::*_t)(int , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Modbustcp::sigMessageToUpperLayer)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Modbustcp::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Modbustcp.data,
      qt_meta_data_Modbustcp,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Modbustcp.stringdata))
...
// SIGNAL 0
void Modbustcp::sigMessageToUpperLayer(int _t1, QString _t2)
{
